public class Motorcycle {
    ...
    public Motorcycle(String color, Frame frame, String decal, Engine engine, Wheel frontWheel, Wheel backWheel, FuelType fuel) {
        this.color = color;
        this.frame = frame;
        this.decal = decal;
        this.engine = engine;
    ...
    public void setFuel(int index) { fuel = FuelType.values()[index - 1]; }
